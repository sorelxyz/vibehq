        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    className="p-2 text-neutral-400 hover:text-neutral-100 hover:bg-neutral-800 rounded transition-colors"
                    title="Edit"
                  >
              ...
              <p className="text-sm text-neutral-400 truncate" title={project.path}>
                {project.path}
              </p>
            </div>
          ))}
